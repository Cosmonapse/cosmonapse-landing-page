...
export const metadata: Metadata = {
  ...
  description: "v0.2 manual SDK · v0.3 Axon-as-MCP · v0.4 declarative router · v0.5 router agent. Plus what is deliberately excluded.",
};
  ...
  return (
    <>
      <header className="page-header">
        <div className="container">
          ...
          <p className="page-sub">
            Cosmonapse evolves in four deliberate stages. v0.2 gives developers raw primitives and a working
            SDK. v0.3 opens the Axon to remote agents via MCP. v0.4 makes orchestration declarative. v0.5
        ...
        <div className="container container-narrow">
          <div className="timeline">
            <div className="timeline-item current">
              <div className="timeline-version">v0.2 · current — manual SDK</div>
              ...
              <div className="timeline-body">
                ...
                <ul>
                  ...
                  <li>TypeScript SDK v0.2 — envelope, builders, MemorySynapse, NatsSynapse, RegistryStore mirror, Axon, Dendrite</li>
                </ul>
              </div>
            </div>

            <div className="timeline-item">
              <div className="timeline-version">v0.3 · next — Axon as MCP server</div>
              ...
              <div className="timeline-body">
                ...
                <ul>
                  ...
                  <li>TypeScript SDK additions — KafkaSynapse, SqliteRegistryStore / PostgresRegistryStore, provider-backed Neuron factories</li>
                </ul>
              </div>
            </div>

            <div className="timeline-item">
              <div className="timeline-version">v0.4 · next — declarative router</div>
            ...
            <div className="timeline-item">
              <div className="timeline-version">v0.5 · future — router agent</div>
      ...
      <section className="section">
        <div className="container container-narrow">
          <div className="sub-eyebrow">Out of scope for v0.2</div>
          <h2 className="sub-title">What we deliberately are not shipping.</h2>
          <p className="prose">
            Every item below is a thing Cosmonapse will not build in v0.2, and the reason it&rsquo;s held
          ...
          <table className="spec-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Post-v0.2 — v0.5 brings protocol-level support</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>Ships in v0.3 — in-process Axon ships first</td>
              </tr>
              <tr>
                <td style={{ color: "var(--text)" }}>Declarative router DSL</td>
                <td>Ships in v0.4 — manual Dendrite comes first</td>
              </tr>
              <tr>
      ...
      <section className="section-sm">
        <div className="container container-narrow">
          <div className="sub-eyebrow">Build order — v0.2</div>
