...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "A Cortex spreads TASKs across interchangeable worker Neurons round-robin. Same topology on five stacks: Python and TypeScript over devsynapse, NATS, Kafka.",
