...
const scaffoldSnippet = `<span class="tk-op">$</span> cosmo init building-a-neuron <span class="tk-op">-n</span> demo

<span class="tk-cm">  Scaffolded building-a-neuron in ./building-a-neuron</span>
